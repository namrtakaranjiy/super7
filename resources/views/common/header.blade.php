    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        window.addEventListener('scroll', function() {
            ...
            if (currentScroll > lastScrollTop) {
                // Scroll down
                navbarBrand.classList.add('scroll-hidden');
                navbarToggler.classList.add('scroll-hidden');
            } else if (currentScroll === 0) {
                // Scroll up to the top
                navbarBrand.classList.remove('scroll-hidden');
                navbarToggler.classList.remove('scroll-hidden');
            }
                    ...
                    <div class="nav navbar-nav menu_nav justify-content-end">
                            @if (Request::segment(1) != 'help')
                                <div class="nav-item ml-3">
                                    &nbsp &nbsp<a class="nav-link p-2" href="{{ url('property/create') }}" aria-label="property-create">
                                       &nbsp &nbsp <button class="btn vbtn-outline-success text-13 font-weight-700">
